...
interface SubmissionModalProps {
	...
	onClose: () => void;
	onStatusChange: (email: string, status: "selected" | "rejected") => void;
}
...
export default function SubmissionModal({
	...
	const handleStatusChange = async (status: "selected" | "rejected") => {
		setIsUpdating(true);
		try {
			...
			toast.success(`Submission ${status === "selected" ? "accepted" : "rejected"}`);
		} catch (error) {
