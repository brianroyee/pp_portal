						...
						<div className="flex space-x-4">
							...
							{submission.status === "rejected" && (
								<>
									...
									<button
										onClick={() => handleStatusChange("rejected_final")}
										disabled={isUpdating}
										className="flex-1 py-3 cursor-pointer bg-purple-500 hover:bg-purple-600 disabled:bg-purple-300 text-white rounded-xl transition-colors flex items-center justify-center space-x-2"
									>
										{isUpdating ? (
											<span className="flex items-center">
												<svg
